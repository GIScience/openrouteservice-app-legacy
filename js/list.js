 ...
 */
list = {
    prefNames: ['pos', 'zoom', 'layer', 'routeOpt', 'avHigh', 'avToll', 'avArea', 'wp', 'lang', 'routeLang', 'distUnit', 'version', 'avUnpaved', 'avFerry', 'value_length', 'value_height', 'value_weight', 'value_width', 'value_axleload', 'surface', 'incline', 'slopedCurb', 'hazardous', 'routeWeight', 'avSteps', 'routeOptType', 'trackType', 'smoothness', 'avFords', 'maxspeed', 'avPaved', 'avTunnel'],
    ...
    //     'StateRoad': {'de': 'Bundesstraße', 'en': 'State Road'},
    //     'Road': {'de': 'Landstraße', 'en': 'Road'},
    //     'Street': {'de': 'Straße', 'en': 'Street'},
    //     'Path': {'de': 'Weg', 'en': 'Path'},
    //     'Track': {'de': 'Bahngleis', 'en': 'Track'},
    //     'Cycleway': {'de': 'Fahrradweg', 'en': 'Cycleway'},
    //     'Footway': {'de': 'Gehweg', 'en': 'Footway'},
    //     'Steps': {'de': 'Stufen', 'en': 'Steps'},
    //     'Ferry': {'de': 'Fähre', 'en': 'Ferry'},
    //     'Construction': {'de': 'in Bau', 'en': 'Construction'},
    // },
    // //SurfaceTypeTranslations
    // SurfaceTranslation: {
    //     'Other': {'de': 'Andere', 'en': 'Other'},
    //     'Paved': {'de': 'Gepflastert', 'en': 'Paved'},
    //     'Unpaved': {'de': 'Ungepflastert', 'en': 'Unpaved'},
    //     'Asphalt': {'de': 'Asphalt', 'en': 'Asphalt'},
    //     'Concrete': {'de': 'Beton', 'en': 'Concrete'},
    //     'Cobblestone': {'de': 'Pflastersteine', 'en': 'Cobblestone'},
    //     'Metal': {'de': 'Metall', 'en': 'Metal'},
    //     'Wood': {'de': 'Holz', 'en': 'Wood'},
    //     'CompactedGravel': {'de': 'Verdichteter Schotter', 'en': 'Compacted Gravel'},
    //     'FineGravel': {'de': 'Splitt oder Kies', 'en': 'Fine Gravel'},
    //     'Gravel': {'de': 'Schotter', 'en': 'Gravel'},
    //     'Dirt': {'de': 'Unbefestigt', 'en': 'Dirt'},
    //     'Ground': {'de': 'Erde', 'en': 'Ground'},
    //     'Ice': {'de': 'Eis', 'en': 'Ice'},
    //     'Salt': {'de': 'Salz', 'en': 'Salt'},
    //     'Sand': {'de': 'Sand', 'en': 'Sand'},
    //     'Woodchips': {'de': 'Holzschnitzel', 'en': 'Woodchips'},
    //     'Grass': {'de': 'Gras', 'en': 'Grass'},
    //     'GrassPaver': {'de': 'Rasengittersteine', 'en': 'Grass Paver'},
    // },
