...
OpenRouteService.namespaces.services = {
...
OpenRouteService.namespaces.layerWms = 'http://129.206.228.72/cached/osm?';
//url to Open Map Surfer layer
OpenRouteService.namespaces.layerMapSurfer = 'http://129.206.74.245:8001/tms_r.ashx?x=${x}&y=${y}&z=${z}';
//url to hillshade overlay
OpenRouteService.namespaces.layerHs = 'http://129.206.228.72/cached/hillshade?';
//urls to TMC overlay
OpenRouteService.namespaces.overlayTmc = 'http://koenigstuhl.geog.uni-heidelberg.de/tmc/wms';
OpenRouteService.namespaces.overlayTmcLines = 'http://openls.geog.uni-heidelberg.de/geoserver/wms';
