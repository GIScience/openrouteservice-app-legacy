...
$object->api_key = isset($_GET["api_key"]) ? $_GET["api_key"] : Null;

$object->via = (isset($_GET["via"])) ? explode(" ", $_GET["via"]) : null;
if ($object->via == null) {unset($object->via);}

//
$object->instructions = (isset($_GET["instructions"]) && $_GET["instructions"] == "true") ? "true" : null;
if ($object->instructions == null) {unset($object->instructions);}
if (isset($object->instructions)) {$object->language = (isset($_GET["lang"])) ? $_GET["lang"] : "en";}
