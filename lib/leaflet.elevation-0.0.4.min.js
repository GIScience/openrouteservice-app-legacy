L.Control.Elevation = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        buttontest.appendChild(t);
        buttontest.setAttribute("id", "btnwtf");
        buttontest.addEventListener("click", function(){
        console.log("Hello World");
        });
        console.log(this);
        buttontest.addEventListener("click", this._collapse);
        container.appendChild(buttontest);
        //this._btn = buttontest;
        //console.log(container);
        //console.log(this._collapse);
        
        
        // if(el){
        //   el.addEventListener('click', this._collapse);
        // }
        //document.getElementById("btn").addEventListener("click", this._collapse);
       // buttontest.on('click', this._collapse, this);
        //L.DomEvent.on(buttontest, 'click', this._collapse, this);
